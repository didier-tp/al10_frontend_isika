...
class GenericMongoDataService {
    ...
    //dbB() = utility function for accessing mongoDB connection initialized in myAppConnectionMap
    dB() {
        return new Promise((resolve, reject) => {
            let myMongoConnection = db_connections_1.myAppConnectionMap.getConnection(this.connectionName);
