...
var simpleAsync_1 = require("../simpleAsync");
    ...
    */
    it("abc shoud be ABC in upperCase with returned Promise ", function () {
        return simpleAsync.getUppercaseDataAfterDelay("abc", 500)
            .then(function (s) { expect(s).to.equals("ABC"); })
            .catch(function (err) { expect.fail(err); });
    });
    it("abc shoud be ABC in upperCase with async/await", function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, simpleAsync.getUppercaseDataAfterDelay("abc", 500)];
                    case 1:
                        s = _a.sent();
