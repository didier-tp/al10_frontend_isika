...
var seqAsync_promise_1 = require("../seqAsync-promise");
...
describe("MyAsyncSequence tests", function () {
    ...
    it("account with .num==2 when calling getAccountByNumAfterDelay(2,500)", function () {
        return seqAsync_promise_1.MyAsyncSequence.getAccountByNumAfterDelay(2, 500)
            .then(function (account) { expect(account.num).to.equals(2); })
            .catch(function (err) { expect.fail(err); });
    });
    it("user with .userId==6 when calling getUserByIdAfterDelay(6,500)", function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, seqAsync_promise_1.MyAsyncSequence.getUserByIdAfterDelay(6, 500)];
                    case 1:
                        user = _a.sent();
